...
nextgoal – See the top priority goal.

remember <text> – Save a memory.

recall <keyword> – Search saved memories.

dashboard – Open the live world dashboard.

script – Enter StackVM script mode (end with END).

status – Show emotions, growth, and wealth.
